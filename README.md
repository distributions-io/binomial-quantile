...
The [quantile function](https://en.wikipedia.org/wiki/Quantile_function) for a [Binomial](https://en.wikipedia.org/wiki/Binomial_distribution) random variable is

<div class="equation" align="center" data-raw-text="" data-equation="eq:quantile_function">
	<img src="" alt="Quantile function for a Binomial distribution.">
	<br>
</div>

for `0 <= p < 1`, where `n` is the number of trials and `p ` is the success probability.
