...
describe( 'distributions-binomial-quantile', function tests() {
	...
	it( 'should compute the Binomial quantile when provided a number', function test() {
	...
	it( 'should evaluate the Binomial quantile when provided a plain array', function test() {
	...
	it( 'should evaluate the quantle function of the Binomial distribution when provided a typed array', function test() {
	...
	it( 'should evaluate the Binomial quantile function element-wise and return an array of a specific type', function test() {
	...
	it( 'should evaluate the Binomial quantile function element-wise using an accessor', function test() {
	...
	it( 'should evaluate the Binomial quantile function element-wise and deep set', function test() {
	...
	it( 'should evaluate the Binomial quantile function element-wise when provided a matrix', function test() {
	...
	it( 'should evaluate the Binomial quantile function element-wise and return a matrix of a specific type', function test() {
		var validationData = require( './fixtures/matrix.json' ),
			mat,
			out,
			d1,
