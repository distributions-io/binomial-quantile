...
describe( 'partial quantile', function tests() {
	...
	it( 'should partially apply the quantile function of the Binomial distribution for given parameter values', function test() {
		var quantile;
		quantile = partial( n, p  );
